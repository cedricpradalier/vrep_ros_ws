...
#ifndef __robot_control_base__GOTOXYCONFIG_H__
#define __robot_control_base__GOTOXYCONFIG_H__
...
namespace robot_control_base
{
  ...
  public:
    ...
    public:
      ...
      virtual void clamp(GotoXYConfig &config, const GotoXYConfig &max, const GotoXYConfig &min) const = 0;
      virtual void calcLevel(uint32_t &level, const GotoXYConfig &config1, const GotoXYConfig &config2) const = 0;
      virtual void fromServer(const ros::NodeHandle &nh, GotoXYConfig &config) const = 0;
      virtual void toServer(const ros::NodeHandle &nh, const GotoXYConfig &config) const = 0;
      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, GotoXYConfig &config) const = 0;
      virtual void toMessage(dynamic_reconfigure::Config &msg, const GotoXYConfig &config) const = 0;
      virtual void getValue(const GotoXYConfig &config, boost::any &val) const = 0;
    };
    ...
    public:
      ...
      virtual void clamp(GotoXYConfig &config, const GotoXYConfig &max, const GotoXYConfig &min) const override
      {
      ...
      virtual void calcLevel(uint32_t &comb_level, const GotoXYConfig &config1, const GotoXYConfig &config2) const override
      {
        if (config1.*field != config2.*field)
          comb_level |= level;
      }

      virtual void fromServer(const ros::NodeHandle &nh, GotoXYConfig &config) const override
      {
        nh.getParam(name, config.*field);
      }

      virtual void toServer(const ros::NodeHandle &nh, const GotoXYConfig &config) const override
      {
        nh.setParam(name, config.*field);
      }

      virtual bool fromMessage(const dynamic_reconfigure::Config &msg, GotoXYConfig &config) const override
      {
        return dynamic_reconfigure::ConfigTools::getParameter(msg, name, config.*field);
      }

      virtual void toMessage(dynamic_reconfigure::Config &msg, const GotoXYConfig &config) const override
      {
        dynamic_reconfigure::ConfigTools::appendParameter(msg, name, config.*field);
      }

      virtual void getValue(const GotoXYConfig &config, boost::any &val) const override
      {
        val = config.*field;
      }
    };
    ...
    class AbstractGroupDescription : public dynamic_reconfigure::Group
    {
      ...
      virtual void updateParams(boost::any &cfg, GotoXYConfig &top) const= 0;
    ...
    public:
      ...
      virtual void updateParams(boost::any &cfg, GotoXYConfig &top) const override
      {
        PT* config = boost::any_cast<PT*>(cfg);
...
class DEFAULT
{
  public:
    ...
    void setParams(GotoXYConfig &config, const std::vector<AbstractParamDescriptionConstPtr> params)
    {
...
//#line 231 "/opt/ros/noetic/share/dynamic_reconfigure/templates/ConfigType.h.template"
    ...
    bool __fromMessage__(dynamic_reconfigure::Config &msg)
    {
      ...
      {
        ROS_ERROR("GotoXYConfig::__fromMessage__ called with an unexpected parameter.");
        ROS_ERROR("Booleans:");
    ...
    {
      const std::vector<AbstractParamDescriptionConstPtr> &__param_descriptions__ = __getParamDescriptions__();
      const GotoXYConfig &__max__ = __getMax__();
      const GotoXYConfig &__min__ = __getMin__();
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator i = __param_descriptions__.begin(); i != __param_descriptions__.end(); ++i)
        (*i)->clamp(*this, __max__, __min__);
    }

    uint32_t __level__(const GotoXYConfig &config) const
    {
      const std::vector<AbstractParamDescriptionConstPtr> &__param_descriptions__ = __getParamDescriptions__();
      uint32_t level = 0;
      for (std::vector<AbstractParamDescriptionConstPtr>::const_iterator i = __param_descriptions__.begin(); i != __param_descriptions__.end(); ++i)
    ...
    static const GotoXYConfig &__getDefault__();
    static const GotoXYConfig &__getMax__();
    static const GotoXYConfig &__getMin__();
    static const std::vector<AbstractParamDescriptionConstPtr> &__getParamDescriptions__();
    static const std::vector<AbstractGroupDescriptionConstPtr> &__getGroupDescriptions__();

  private:
    static const GotoXYConfigStatics *__get_statics__();
  };
...
//#line 369 "/opt/ros/noetic/share/dynamic_reconfigure/templates/ConfigType.h.template"
    ...
    std::vector<GotoXYConfig::AbstractParamDescriptionConstPtr> __param_descriptions__;
    std::vector<GotoXYConfig::AbstractGroupDescriptionConstPtr> __group_descriptions__;
    GotoXYConfig __max__;
    GotoXYConfig __min__;
    GotoXYConfig __default__;
    dynamic_reconfigure::ConfigDescription __description_message__;

    static const GotoXYConfigStatics *get_instance()
    {
      // Split this off in a separate function because I know that
      // instance will get initialized the first time get_instance is
      // called, and I am guaranteeing that get_instance gets called at
      // most once.
      static GotoXYConfigStatics instance;
      return &instance;
    }
  };

  inline const dynamic_reconfigure::ConfigDescription &GotoXYConfig::__getDescriptionMessage__()
  {
    return __get_statics__()->__description_message__;
  }

  inline const GotoXYConfig &GotoXYConfig::__getDefault__()
  {
    return __get_statics__()->__default__;
  }

  inline const GotoXYConfig &GotoXYConfig::__getMax__()
  {
    return __get_statics__()->__max__;
  }

  inline const GotoXYConfig &GotoXYConfig::__getMin__()
  {
    return __get_statics__()->__min__;
  }

  inline const std::vector<GotoXYConfig::AbstractParamDescriptionConstPtr> &GotoXYConfig::__getParamDescriptions__()
  {
    return __get_statics__()->__param_descriptions__;
  }

  inline const std::vector<GotoXYConfig::AbstractGroupDescriptionConstPtr> &GotoXYConfig::__getGroupDescriptions__()
  {
    return __get_statics__()->__group_descriptions__;
  }

  inline const GotoXYConfigStatics *GotoXYConfig::__get_statics__()
  {
    const static GotoXYConfigStatics *statics;
    ...
    statics = GotoXYConfigStatics::get_instance();
...
#endif // __GOTOXYRECONFIGURATOR_H__
